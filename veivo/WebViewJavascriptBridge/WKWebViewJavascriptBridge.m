...
- (void)webView:(WKWebView *)webView decidePolicyForNavigationAction:(WKNavigationAction *)navigationAction decisionHandler:(void (^)(WKNavigationActionPolicy))decisionHandler {
    ...
    if ([urlString rangeOfString:@"itunes.apple.com"].length>0
        ||([urlString rangeOfString:@"wechat"].length>0&&[urlString rangeOfString:@"pay"].length>0)
        ||([urlString rangeOfString:@"weixin"].length>0&&[urlString rangeOfString:@"pay"].length>0)
        ||[urlString rangeOfString:@"alipay"].length>0) {
